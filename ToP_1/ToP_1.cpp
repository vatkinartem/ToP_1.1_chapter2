		...
		try
		{
			...
			case MODE::EMPLACE:
				...
				if (var == Keeper::vars::STUDENT)
				{
					...
					if (words.getSize() < 6) { throw exception("Not enought fields for Student") ; break; }
				...
				else if (var == Keeper::vars::PROFESSOR)
				{
					...
					if (words.getSize() < 2) { throw exception("Not enought fields for Professor") ; break; }
					Professor tempp;
				...
				else if (var == Keeper::vars::ADMINSTAFF)
				{
					...
					if (words.getSize() < 5) { throw exception("Not enought fields for AdminStaff"); break; }
					AdminStaff tempa;
